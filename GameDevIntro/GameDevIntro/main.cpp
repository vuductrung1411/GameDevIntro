...
void Update(DWORD dt)
{
	...
	//if (brick_y <= 0 || brick_y >= BackBufferHeight - BRICK_WIDTH)
	//{
	//	brick_vy = -brick_vy;
	...
	//		brick_y = 0;
	//	}
	//	else if (brick_y >= BackBufferHeight - BRICK_WIDTH)
	//	{
	//		brick_y = BackBufferHeight - BRICK_WIDTH;
	//	}
	//}
}
*/
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow)
{
	...
	brick.path = L"brick.png";
	brick.setXY(0.0f, 0.0f);
	brick.setVxVy(0.2f, 0.2f);
	brick.height = 16.0f;
	brick.width = 16.0f;

	br.path = L"brick.png";
	br.setXY(50.0f, 50.0f);
	br.setVxVy(0.2f, 0.2f);
	br.height = 16.0f;
	br.width = 16.0f;

	Camera camera = Camera(hWnd, texBrick, d3d, d3ddv, backBuffer, BackBufferWidth, BackBufferHeight, spriteHandler);
